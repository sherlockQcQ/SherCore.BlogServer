...
namespace SherCore.BlogServer.Migrations
{
    ...
    [Migration("20230329060056_update-Post-status")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SherCore.BlogServer.Blogs.Blog", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("SherCore.BlogServer.Categorys.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SherCore.BlogServer.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SherCore.BlogServer.Posts.PostTag", b =>
                {
            ...
            modelBuilder.Entity("SherCore.BlogServer.Tags.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SherCore.BlogServer.Posts.PostTag", b =>
                {
                    b.HasOne("SherCore.BlogServer.Posts.Post", null)
                        .WithMany("Tags")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SherCore.BlogServer.Tags.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
